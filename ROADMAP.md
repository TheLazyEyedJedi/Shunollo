...
This roadmap shows planned features for the open-source Shunollo project. All features listed here will be available to everyone under Apache 2.0.
...
- [x] **Homeostatic Plasticity**: Energy-conserving learning
...
- [ ] **Authentication Providers**: Pluggable auth interfaces
- [ ] **Audit Logging**: Event trail infrastructure
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines. All features are open for community contribution.

## Commercial Applications

Shunollo is designed to be a foundation for building applications. If you're building a commercial product on Shunollo, we'd love to hear about it!

Contact: **hello@shunollo.org**
